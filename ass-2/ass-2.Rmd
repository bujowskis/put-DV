...
head(read.csv("Dataset/Sectors/healthcare.csv"))
prettyTable(read.csv("Dataset/Sectors/healthcare.csv"))
```

### Sentiment missing

```{r nosentiment_repr, echo=FALSE}
head(read.csv("Dataset/Sectors/consumercycle.csv"))
prettyTable(read.csv("Dataset/Sectors/consumercycle.csv"))
```

...
The missing correlation values are marked `NA` and will be colored white. However, in this example there's no correlations missing and the feature cannot be seen.
